...
public class PermissionUtils {
    ...
    //自己的项目包名
    private String packageName = "com.sjy.permission";
     ...
     * 酷派
     */
    private void goCoolpadMainager2() {
        Intent open = mContext.getPackageManager().getLaunchIntentForPackage("com.yulong.android.security:remote");
     ...
     * @return
     */
    public void getSystemManageIntent() {
        Intent intent = new Intent();
