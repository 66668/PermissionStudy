...
import com.sjy.permission.andpermission_util.App;
import com.sjy.permission.andpermission_util.InstallRationale;
import com.sjy.permission.andpermission_util.OverlayRationale;
import com.sjy.permission.andpermission_util.RuntimeRationale;
import com.sjy.permission.andpermission_util.WriteApkTask;
...
public class AndPermissionAct extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_andpermission);
        ...
        AndPermission.with(this)
                ...
                .onDenied(new Action<List<String>>() {
                    ...
                    public void onAction(@NonNull List<String> permissions) {
                        ...
                        if (AndPermission.hasAlwaysDeniedPermission(AndPermissionAct.this, permissions)) {
                            showSettingDialog(AndPermissionAct.this, permissions);
                        }
                    }
                })
                .start();
        ...
        AndPermission.with(this)
                ...
                .onComeback(new Setting.Action() {
                    ...
                    public void onAction() {
                        Toast.makeText(AndPermissionAct.this, R.string.message_setting_comeback, Toast.LENGTH_SHORT).show();
                    }
                })
                .start();
    }
        ...
        AndPermission.with(this)
                ...
                .onGranted(new Action<List<String>>() {
                    ...
                    public void onAction(List<String> data) {
                        new WriteApkTask(AndPermissionAct.this, new Runnable() {
                            @Override
                            public void run() {
                                installPackage();
                            }
